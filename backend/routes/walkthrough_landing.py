...
async def submit_walkthrough_landing(payload: WalkthroughLandingSubmission):
    ...
    try:
        resend.Emails.send({
            "from": SENDER_EMAIL,
            "to": [doc["email"]],
            "subject": "Your GigLine walkthrough request — Vince will be in touch within 24 hours",
            "html": (
                ...
                f"<p>If you need to reach him directly:<br>"
                f"<strong>Phone:</strong> <a href='tel:3363298899'>(336) 329-8899</a><br>"
                f"<strong>Email:</strong> <a href='mailto:vince@giglinecompliance.com'>vince@giglinecompliance.com</a></p>"
                f"<p style='margin-top:32px'>— GigLine Safety &amp; Compliance</p>"
