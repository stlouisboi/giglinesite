    ...
    <footer className="bg-[#091725] text-white" data-testid="footer">
      <div className="container py-12 md:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
          ...
          <div>
            <div className="mb-4">
              <img src="/gigline-logo-dark-bg.png?v=8"
              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li key={link.path}>
                    <Link
                      to={link.path}
                      className="text-sm text-white/60 hover:text-[#1F3F80] transition-colors"
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={link.path + link.name}>
                    <Link
                      to={link.path}
                      className="text-sm text-white/80 hover:text-[#1F3F80] transition-colors font-medium block"
