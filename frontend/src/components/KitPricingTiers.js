...
const KitPricingTiers = ({
  ...
  const intro = introOverride || (universalTiers
    ? 'Every kit in the GigLine Compliance Readiness Kits is offered in three tiers. Buy the level that matches how much of the build you want to do yourself, and how quickly you need the physical binder in the supervisor’s hands.'
