...
const KIT_TIERS = [
  ...
  {
    id: 'binder',
    name: 'Compliance Binder Edition',
    price: 600,
    priceLabel: '$600',
    positioning: 'A professionally printed and assembled physical mirror of your Compliance Control System.',
    ...
    notIncluded: [
      'Facility-specific chemical inventory',
      'SDS collection for your facility',
      'Completed forms (blank forms are provided; filling them in is your responsibility)',
      'Custom program writing or rewriting',
      'Employee training delivery',
      'Document review',
      'Implementation of any findings',
    ],
    limitations: 'This edition is a professionally printed and assembled version of the Compliance Control System. It is not a compliance certification, an OSHA approval, or a completed facility program.',
    badge: null,
