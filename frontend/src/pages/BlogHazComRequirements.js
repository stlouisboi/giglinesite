    ...
    <main data-testid="blog-hazcom-requirements">
        ...
        <div className="container max-w-3xl">
          ...
          <div className="space-y-8">
            {fourRequirements.map((req) => (
              <div key={req.num} className="bg-white border border-[#1C2B2B]/10 rounded p-6" style={{ borderTop: '3px solid #C9A84C' }}>
                <div className="flex items-start gap-3 mb-4">
                  <req.icon size={22} className="text-[#C9A84C] flex-shrink-0 mt-0.5" />
                  <div>
      ...
      <section className="py-12 md:py-16 border-b border-[#1C2B2B]/10" id="written-program">
        <div className="container max-w-3xl">
          ...
          <Link to="/hazcom" className="inline-flex items-center gap-2 text-sm text-[#B8972C] font-medium hover:underline">
          ...
          <ol className="space-y-5">
            {[
              ...
              <li key={i} className="flex items-start gap-4">
                <span className="bg-[#C9A84C] text-white text-sm font-bold w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">{i + 1}</span>
                <div>
      ...
      <section className="py-14 md:py-20 bg-[#1C2B2B] text-white" data-testid="hazcom-blog-cta">
        <div className="container max-w-3xl">
          ...
          <div className="space-y-4 mb-10">
            <Link to="/hazcom" className="flex items-center justify-between p-5 bg-white/5 border border-white/10 rounded hover:border-[#C9A84C]/40 transition-colors group" data-testid="hazcom-blog-cta-pack">
              <div>
                <p className="font-medium text-white group-hover:text-[#C9A84C] transition-colors text-sm">HazCom Starter Pack — $29</p>
                <p className="text-xs text-white/50 mt-1">Written program, SDS checklist, training log. Fill in your company name and print.</p>
              </div>
              <ArrowRight size={18} className="text-white/30 group-hover:text-[#C9A84C] transition-colors flex-shrink-0" />
            </Link>
            <Link to="/safety-check" className="flex items-center justify-between p-5 bg-white/5 border border-white/10 rounded hover:border-[#C9A84C]/40 transition-colors group">
              <div>
                <p className="font-medium text-white group-hover:text-[#C9A84C] transition-colors text-sm">Run the Safety Check</p>
                <p className="text-xs text-white/50 mt-1">Free 90-second assessment to identify HazCom gaps</p>
              </div>
              <ArrowRight size={18} className="text-white/30 group-hover:text-[#C9A84C] transition-colors flex-shrink-0" />
            </Link>
            <Link to="/contact" className="flex items-center justify-between p-5 bg-white/5 border border-white/10 rounded hover:border-[#C9A84C]/40 transition-colors group">
              <div>
                <p className="font-medium text-white group-hover:text-[#C9A84C] transition-colors text-sm">Request a Walkthrough</p>
      ...
      <section className="py-12 bg-[#F9F8F6]">
        <div className="container max-w-3xl">
          <div className="border border-[#C9A84C]/20 bg-white rounded-lg p-6 md:p-8 text-center" data-testid="blog-walkthrough-callout">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-[#1C2B2B]/50">
                ...
                <a href="tel:3363298899" className="text-[#B8972C] hover:underline">(336) 329-8899</a>
                <span className="text-[#1C2B2B]/30 mx-1">|</span>
