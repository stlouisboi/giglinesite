      ...
      <section className="py-14 md:py-20 bg-[#0d1b2a] text-white" data-testid="hazcom-blog-cta">
        <div className="container max-w-3xl">
          ...
          <div className="space-y-4 mb-10">
            <Link to="/hazcom" className="flex items-center justify-between p-5 bg-white/5 border border-white/10 rounded hover:border-[#1a6fc4]/40 transition-colors group" data-testid="hazcom-blog-cta-pack">
              <div>
                <p className="font-medium text-white group-hover:text-[#1a6fc4] transition-colors text-sm">HazCom Starter Pack — $29</p>
            ...
            <Link to="/safety-check" className="flex items-center justify-between p-5 bg-white/5 border border-white/10 rounded hover:border-[#1a6fc4]/40 transition-colors group">
              <div>
                <p className="font-medium text-white group-hover:text-[#1a6fc4] transition-colors text-sm">Run the Safety Check</p>
                <p className="text-xs text-white/50 mt-1">Free 90-second assessment to identify HazCom gaps</p>
              </div>
              <ArrowRight size={18} className="text-white/30 group-hover:text-[#1a6fc4] transition-colors flex-shrink-0" />
            </Link>
            <Link to="/contact" className="flex items-center justify-between p-5 bg-white/5 border border-white/10 rounded hover:border-[#1a6fc4]/40 transition-colors group">
              <div>
                <p className="font-medium text-white group-hover:text-[#1a6fc4] transition-colors text-sm">Request a Walkthrough</p>
