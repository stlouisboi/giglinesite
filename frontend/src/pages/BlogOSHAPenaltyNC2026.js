    ...
    <article className="container max-w-3xl py-16">
      <div className="prose prose-lg max-w-none">
        ...
        <ul className="mb-6 text-[16px] leading-[1.9] pl-6 text-[#1C2B2B]/80" style={{ fontFamily: "Georgia, serif" }}>
          <li><strong>Machine Guarding (1910.212)</strong> , six identical unguarded machines = six citations.</li>
          <li><strong>Powered Industrial Trucks (1910.178(l))</strong> , five forklift operators without a completed four-element training certification = five citations.</li>
          <li><strong>Lockout/Tagout (1910.147(c)(4))</strong> , three machines with no written machine-specific procedure = three citations.</li>
          <li><strong>Hazard Communication (1910.1200(f)(6))</strong> , ten unlabeled secondary containers in the maintenance shop = ten citations.</li>
          <li><strong>Respiratory Protection (1910.134)</strong> , four employees without a completed medical evaluation before respirator use = four citations.</li>
          <li><strong>Personal Protective Equipment (1910.132)</strong> , when the employer has not completed a written hazard assessment for each job.</li>
        </ul>
        ...
        <ol className="mb-6 text-[16px] leading-[1.9] pl-6 text-[#1C2B2B]/80" style={{ fontFamily: "Georgia, serif" }}>
          <li><strong>Gravity</strong> , severity of the injury the hazard could cause × probability that injury actually happens. Highest at "high-severity, greater-probability" = full maximum.</li>
          <li><strong>Size</strong> , employer size reduction: 60% off for ≤10 employees, 30% off for 11-25, 10% off for 26-100, 0% off for 101+.</li>
          <li><strong>Good Faith</strong> , 25% off for a demonstrated safety-management system with written programs, training records, and evidence of corrective action follow-through.</li>
