...
const BlogOSHAViolations = () => {
  return (
    <main data-testid="blog-osha-violations">
      ...
      {/* Penalty Table */}
      <section className="py-12 md:py-16 border-b border-[#102133]/10" id="penalties">
        <div className="container max-w-3xl">
          <h2
            className="text-xl md:text-2xl font-bold text-[#102133] mb-2"
            style={{ fontFamily: "Georgia, 'Times New Roman', serif" }}
          >
            What is the penalty for OSHA violations in 2025?
          </h2>
          <p className="text-sm text-[#102133]/50 mb-6">As of January 2025. Adjusted annually for inflation.</p>
          ...
          <p className="text-xs text-[#102133]/50 mt-4">
      ...
      {violations.map((v) => (
        <section
          key={v.num}
          className="py-12 md:py-16 border-b border-[#102133]/10"
          id={`violation-${v.num}`}
          data-testid={`violation-section-${v.num}`}
        >
          <div className="container max-w-3xl">
            <div className="flex items-start gap-4 mb-6">
              <div className="bg-[#102133] text-white w-10 h-10 rounded flex items-center justify-center flex-shrink-0">
                <v.icon size={20} />
              </div>
              <div>
                <p
                  className="text-xs text-[#102133]/40 font-semibold tracking-widest uppercase mb-1"
                  style={{ fontFamily: "'JetBrains Mono', monospace" }}
                >
                  {v.cfr}
                </p>
                <h2
                  className="text-xl md:text-2xl font-bold text-[#102133]"
                  style={{ fontFamily: "Georgia, 'Times New Roman', serif" }}
                >
                  {v.num}. {v.title}
                </h2>
            ...
            <p className="text-[#102133]/60 italic mb-8 text-sm">{v.tagline}</p>
            ...
            {v.deepLink && (
              <div className="mb-8">
                <Link
                  to={v.deepLink.to}
                  className="inline-flex items-center gap-2 text-xs text-[#102133]/50 hover:text-[#1560ae] transition-colors"
                >
                  {v.deepLink.text}
                </Link>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-sm font-semibold text-[#102133] mb-3 uppercase tracking-wider">Why It's Cited</h3>
              ...
              <div>
                <h3 className="text-sm font-semibold text-[#102133] mb-3 uppercase tracking-wider">What OSHA Requires</h3>
                <ul className="space-y-2">
          ...
          <ol className="space-y-4">
            {[
              ...
              <li key={i} className="flex items-start gap-4">
                <span className="bg-[#102133] text-white text-sm font-bold w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  {i + 1}
                </span>
                <div>
                  <p className="font-semibold text-[#102133] text-sm">{item.title}</p>
                  <p className="text-sm text-[#102133]/60">{item.desc}</p>
                </div>
              </li>
            ))}
          </ol>
      ...
      {/* Signs Section */}
      <section className="py-12 md:py-16 border-b border-[#102133]/10">
        <div className="container max-w-3xl">
          <h2
            className="text-xl md:text-2xl font-bold text-[#102133] mb-6"
            style={{ fontFamily: "Georgia, 'Times New Roman', serif" }}
          ...
          <p className="text-[#102133]/60 mb-6 text-sm">Signs your operation may have compliance gaps:</p>
      ...
      <section className="py-14 md:py-20 bg-[#102133] text-white" data-testid="blog-cta-section">
        <div className="container max-w-3xl">
          <h2
