  ...
  return (
    <main data-testid="blog-osha-violations">
      ...
      <section className="py-10 border-b border-[#1C2B2B]/10">
        <div className="container max-w-3xl">
          <div className="bg-[#F9F8F6] border-l-3 border-[#C9A84C] p-6 rounded" style={{ borderLeft: '3px solid #C9A84C' }}>
            ...
            <ol className="space-y-2">
              {violations.map((v) => (
                <li key={v.num} className="flex items-start gap-3 text-sm text-[#1C2B2B]/70">
                  <span className="font-bold text-[#C9A84C] flex-shrink-0">{v.num}.</span>
      ...
      <section className="py-14 md:py-20 bg-[#1C2B2B] text-white" data-testid="blog-cta-section">
        <div className="container max-w-3xl">
          ...
          <div className="space-y-4 mb-10">
            <Link
              to="/safety-check"
              className="flex items-center justify-between p-5 bg-white/5 border border-white/10 rounded hover:border-[#C9A84C]/40 transition-colors group"
              data-testid="blog-cta-safety-check"
            >
              <div>
                <p className="font-medium text-white group-hover:text-[#C9A84C] transition-colors text-sm">Run the GigLine Safety Check</p>
            ...
            >
              <div>
                <p className="font-medium text-white group-hover:text-[#C9A84C] transition-colors text-sm">Request a Safety Walkthrough</p>
            ...
            >
              <div>
                <p className="font-medium text-white group-hover:text-[#C9A84C] transition-colors text-sm">HazCom Starter Pack</p>
