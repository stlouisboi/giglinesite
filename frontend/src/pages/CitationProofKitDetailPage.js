...
const CitationProofKitDetailPage = () => {
  ...
  // Hidden-from-catalog kits render a controlled "coming soon" state. No
  // pricing, no checkout, no schema, noindex. An interest link routes to the
  ...
  return (
    <main data-testid={`kit-detail-page-${slug}`} style={{ backgroundColor: BG_WARM, color: NAVY }}>
      ...
      <ProofGapEngineSteps
        ...
        intro="This kit runs on the same four-step control loop as every kit in the GigLine Compliance Readiness Kits. The sequence is what turns forms into a system."
      />
