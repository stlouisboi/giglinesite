...
import { SAFETY_WALKTHROUGH } from '../data/servicePricing';
...
const CITIES = {
  ...
  'charlotte': {
    ...
    seoDesc: 'OSHA safety walkthroughs for Charlotte light manufacturers, construction contractors, plastics processors, and distribution operations. Written report. Starting at $1,300.',
  ...
  'raleigh': {
    ...
    seoDesc: 'OSHA safety walkthroughs for Raleigh, Durham, and Triangle-area pharma, medical device, food production, and small manufacturing operations. Written report. Starting at $1,300.',
  ...
  'burlington': {
    ...
    seoDesc: 'OSHA safety walkthroughs for Burlington and Alamance County textile manufacturers, fabrication shops, plastics processors, and distribution operations. Starting at $1,300.',
  ...
  'thomasville': {
    ...
    seoDesc: 'OSHA safety walkthroughs for Thomasville furniture manufacturers, woodworking shops, upholstery operations, and small fabrication shops. Written report. Starting at $1,300.',
  ...
  'clemmons': {
    ...
    seoDesc: 'OSHA safety walkthroughs for Clemmons light manufacturers, automotive parts suppliers, fabrication shops, and food and beverage producers. Written report. Starting at $1,300.',
  ...
  'mocksville': {
    ...
    industries: 'small manufacturers, agricultural equipment operations, and metal fabrication shops',
    seoTitle: 'Safety Walkthroughs in Mocksville, NC',
    seoDesc: 'OSHA safety walkthroughs for manufacturers and fabrication shops in Mocksville, NC and Davie County. Written report. Starting at $1,300.',
    leadParagraph: "Mocksville sits at the intersection of I-40 and Highway 601 in Davie County, and the industrial footprint that runs from the Cooleemee corridor through the northern edge of the county hosts a working mix of small manufacturers, agricultural equipment operations, metal fabrication shops, and the building-materials producers that serve the residential growth along the western Triad. Ashley Furniture\u2019s regional distribution operations, Ingersoll Rand\u2019s legacy manufacturing footprint, and a broader tier of small fabrication shops, plastics processors, and food-adjacent operations sit alongside the family-owned production businesses that anchor Davie County\u2019s economy. The OSHA exposures most common across these operations include machine guarding, forklift traffic in warehousing, welding and cutting operation controls, lockout/tagout on production equipment, and the documentation gaps that follow when a small operation outgrows the safety practices that worked at five employees.\n\nGigLine works with Mocksville and Davie County operations that fit the small-operator profile: 5 to 100 employees, single facility, no dedicated safety person. A typical engagement starts with an on-site walkthrough, Vince walks your floor for one to three hours, photographs every finding, and annotates each with the relevant CFR citation and an estimated penalty exposure based on OSHA published maximums. The written report lands within 48 hours with a prioritized RED / AMBER / GREEN fix list supervisors can actually work from. Mocksville is twenty-five miles from GigLine\u2019s Kernersville base, engagements scheduled within 5 to 10 business days. Fixed quote before scheduling. Private engagement. No retainer.",
  },
  'salisbury': {
    name: 'Salisbury',
    region: 'Rowan County',
    distance: '50 miles from our base in Kernersville',
    industries: 'manufacturing plants, food and beverage producers, and Rowan County distribution centers',
    seoTitle: 'Safety Walkthroughs in Salisbury, NC',
    seoDesc: 'On-site OSHA safety walkthroughs for manufacturers and distribution centers in Salisbury, NC. Written report with findings. Starting at $1,300 + travel fee.',
    travelNote: true,
    leadParagraph: "Salisbury anchors Rowan County at the southern end of the Piedmont Triad, and the industrial corridor along I-85, Highway 601, and Jake Alexander Boulevard hosts a working mix of manufacturing plants, food and beverage producers, and the large-scale distribution operations that feed the Charlotte metro market. Food Lion\u2019s corporate headquarters and distribution footprint anchor the local economy, alongside Freightliner\u2019s Salisbury manufacturing complex, Duracell\u2019s battery plant north of town, and a broader tier of contract fabricators, plastics processors, and warehouse and logistics operations concentrated between the I-85 and Highway 29 corridors. Across those operations, the most common OSHA exposures track a familiar pattern: machine guarding on production lines, forklift traffic in high-throughput distribution facilities, chemical storage and labeling on food and industrial process lines, lockout/tagout on packaging equipment, and the documentation gaps that surface during customer audits or insurance reviews.\n\nGigLine works with Salisbury and Rowan County operations that fit the small-operator profile: 5 to 100 employees, single facility, no full-time safety manager. Engagements include the on-site walkthrough, the Compliance Readiness Visit, and the documentation development that follows. Salisbury is fifty miles from GigLine\u2019s Kernersville base, so a travel fee applies alongside the base engagement price, most walkthroughs are scheduled within 7 to 10 business days. Fixed quote before scheduling. Private engagement. No retainer.",
  },
  'asheboro': {
    name: 'Asheboro',
    region: 'Randolph County',
    distance: '35 miles from our base in Kernersville',
    industries: 'metal fabrication shops, plastics and packaging operations, and distribution warehouses',
    seoTitle: 'Safety Walkthroughs in Asheboro, NC',
    seoDesc: 'OSHA safety walkthroughs for manufacturers, metal fabricators, and distribution operations in Asheboro, NC and Randolph County. Written report with findings. Starting at $1,300 + travel fee.',
    travelNote: true,
    leadParagraph: "Asheboro sits at the center of Randolph County along Highway 64 and Highway 220, and the industrial footprint that runs from the Klaussner Furniture corridor through the Randolph County Industrial Park hosts a working ecosystem of metal fabricators, plastics and packaging producers, small manufacturers, and the distribution and warehousing operations that support the broader Triad-to-Sandhills logistics corridor. Klaussner\u2019s furniture manufacturing legacy still anchors part of the industrial base, alongside Post Consumer Brands' cereal plant north of town, a growing cluster of plastics and packaging operations, and small fabrication shops serving both the furniture supply chain and regional industrial customers. Across those operations, the OSHA exposures most likely to surface during an inspection include machine guarding on stamping and fabrication equipment, powered industrial truck (PIT) safety on warehouse and manufacturing floors, hazardous energy control on packaging lines, chemical hazard communication on finishing and coating operations, and the documentation and training gaps that follow when a small operation grows past the point where informal safety practices still cover the risk.\n\nGigLine works with Asheboro and Randolph County operations that fit the small-operator profile: 5 to 100 employees, single facility, no dedicated safety person. A typical engagement starts with an on-site walkthrough, Vince walks your floor for one to three hours, photographs every finding, and annotates each with the relevant CFR citation and an estimated penalty exposure based on OSHA published maximums. Within 48 hours you receive a written report with a prioritized RED / AMBER / GREEN fix list. Operations that need both the floor and the files reviewed in one visit choose the Compliance Readiness Visit, which combines the walkthrough with a 53-item documentation review. Asheboro is thirty-five miles from GigLine\u2019s Kernersville base, so a travel fee applies alongside the base engagement price, most walkthroughs are scheduled within 7 to 10 business days. Fixed quote before scheduling. Private engagement. No retainer.",
  },
};
...
const CityLandingPage = () => {
  ...
  const priceStart = SAFETY_WALKTHROUGH.amount;
  const priceStartLabel = data.travelNote
    ? `Starting at ${SAFETY_WALKTHROUGH.displayPrice} plus applicable travel fee`
    : `Starting at ${SAFETY_WALKTHROUGH.displayPrice}`;

  const cityFaqs = [
    {
      q: `How much does a safety walkthrough cost in ${data.name}, NC?`,
      a: `Safety walkthroughs for ${data.name}-area operations start at ${SAFETY_WALKTHROUGH.displayPrice}. You\u2019ll receive a fixed quote before scheduling.${data.travelNote ? ` ${data.name} is outside the Triad core, so an applicable travel fee is added to the base walkthrough price. The quote is confirmed in writing before any visit is scheduled.` : ''}`,
    },
    {
      ...
      <section className="py-16 md:py-20 bg-[#102A43] text-white">
        <div className="container max-w-2xl text-center">
          ...
          <p className="text-white/50 mb-8">
            You&rsquo;ll receive a fixed quote before we schedule the visit. No retainer.
          </p>
          {data.travelNote && (
            <p className="text-white/50 mb-8 text-sm">
              {data.name} is {data.distance}. An applicable travel fee is added to the base walkthrough price and confirmed in the written quote before scheduling.
            </p>
          )}
