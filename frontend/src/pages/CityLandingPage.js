  ...
  return (
    <main data-testid={`city-page-${city}`}>
      ...
      <section className="bg-[#0D1B2A] text-white py-16 md:py-24">
        <div className="container max-w-4xl">
          <div className="flex items-center gap-2 mb-6">
            ...
            <p className="uppercase tracking-[3px] text-[#C9A84C]" style={{ ...mono, fontSize: '11px' }}>
      ...
      <section className="py-16 md:py-24" style={{ backgroundColor: '#F9F8F6' }}>
        <div className="container max-w-4xl">
          <p className="uppercase tracking-[3px] text-[#C9A84C] mb-4" style={{ ...mono, fontSize: '11px' }}>
            What You Get
          </p>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              <div key={i} className="flex items-start gap-3">
                <Check size={16} className="flex-shrink-0 mt-1 text-[#C9A84C]" strokeWidth={2.5} />
      ...
      <section className="py-16 md:py-20 bg-[#0D1B2A] text-white">
        <div className="container max-w-2xl text-center">
          ...
          <p className="mt-6 text-white/40 text-sm">
            Or call directly: <a href="tel:3363298899" className="text-[#C9A84C] hover:underline font-semibold">(336) 329-8899</a>
          </p>
        </div>
      </section>
    </main>
