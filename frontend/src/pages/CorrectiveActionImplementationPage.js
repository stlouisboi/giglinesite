...
},
{
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Is this a retainer or subscription?', acceptedAnswer: { '@type': 'Answer', text: 'No. Corrective Action Implementation is scoped per project with a fixed quote. When the selected findings are closed and evidence is organized, the engagement ends. For ongoing month-over-month support, see Ongoing Safety Support (starting at $1,850 per month).' } },
