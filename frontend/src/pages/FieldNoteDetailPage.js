...
const SERVICE_LINKS_BY_SLUG = {
  'heat-stress': [
    ...
    { title: 'Corrective Action Implementation', body: 'Written HIIPP, daily heat check, and training records that match your operation.', to: '/services/corrective-action-implementation' },
  ],
  'forklift-safety': [
    ...
    { title: 'Corrective Action Implementation', body: 'Operator certifications, evaluation records, and pre-shift checklists that satisfy 1910.178(l).', to: '/services/corrective-action-implementation' },
  ],
  'electrical-safety': [
  ...
  'hazcom': [
    { title: 'Corrective Action Implementation', body: 'Written HazCom program, container labels, SDS index, and training records for the most-cited OSHA standard.', to: '/services/corrective-action-implementation' },
  ...
  'lockout-tagout': [
    { title: 'Corrective Action Implementation', body: 'Written LOTO program, machine-specific procedures, periodic inspection records, and training documentation.', to: '/services/corrective-action-implementation' },
  ...
  'emergency-action-plans': [
    { title: 'Corrective Action Implementation', body: 'Written EAP, evacuation diagrams, alarm-system documentation, and drill records to satisfy 1910.38.', to: '/services/corrective-action-implementation' },
  ],
  'ppe-assessment': [
    { title: 'Corrective Action Implementation', body: 'Written PPE hazard assessment certification, the first citation under 1910.132 when missing.', to: '/services/corrective-action-implementation' },
  ],
  'fall-protection': [
  ...
  'confined-space': [
    { title: 'Corrective Action Implementation', body: 'Written permit-required program, entry permits, and rescue plan that satisfies 1910.146.', to: '/services/corrective-action-implementation' },
  ...
  'hearing-conservation': [
    { title: 'Corrective Action Implementation', body: 'Written hearing conservation program, audiogram records, and noise exposure assessments per 1910.95.', to: '/services/corrective-action-implementation' },
  ],
  'bloodborne-pathogens': [
    { title: 'Corrective Action Implementation', body: 'Written exposure control plan, hepatitis B vaccination records, and training documentation per 1910.1030.', to: '/services/corrective-action-implementation' },
  ],
  'ai-generated-safety-programs': [
    { title: 'Corrective Action Implementation', body: 'Written programs built around your equipment and chemicals, not AI templates that name a different operation.', to: '/services/corrective-action-implementation' },
  ],
  'recordkeeping-300-log': [
    ...
    { title: 'Corrective Action Implementation', body: 'Recordable-injury decision tree and 300/300A maintenance procedure built for your operation.', to: '/services/corrective-action-implementation' },
  ],
  'respiratory-protection': [
    { title: 'Corrective Action Implementation', body: 'Written respiratory protection program, medical evaluation, fit testing, and training records per 1910.134.', to: '/services/corrective-action-implementation' },
  ],
  'silica-respirable-crystalline': [
    ...
    { title: 'Corrective Action Implementation', body: 'Written silica exposure control plan tailored to the tasks and materials on your floor.', to: '/services/corrective-action-implementation' },
  ],
  'hot-work-welding': [
    ...
    { title: 'Corrective Action Implementation', body: 'Written hot work permit program (NFPA 51B-based) that insurance carriers and customers accept.', to: '/services/corrective-action-implementation' },
  ],
  'abrasive-wheels': [
  ...
  'eye-face-protection': [
    { title: 'Corrective Action Implementation', body: 'Written PPE hazard assessment certification per 1910.132, the first citation when missing.', to: '/services/corrective-action-implementation' },
  ],
  ...
  'cranes-rigging': [
    ...
    { title: 'Corrective Action Implementation', body: 'Annual inspection logs, operator training records, and rigging gear inspection procedures.', to: '/services/corrective-action-implementation' },
  ],
  'nc-osha-vs-federal': [
