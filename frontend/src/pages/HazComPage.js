      ...
      <section className="py-16 md:py-24 bg-[#102133] text-white" data-testid="hazcom-cta-section">
        <div className="container max-w-2xl text-center">
          ...
          <button
            ...
            disabled={isLoading}
            className="bg-[#1a6fc4] hover:bg-[#1560ae] text-[#102133] font-bold text-lg px-10 py-4 rounded transition-colors disabled:opacity-50 inline-flex items-center gap-2"
