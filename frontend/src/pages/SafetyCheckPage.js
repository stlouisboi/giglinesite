...
const SafetyCheckPage = () => {
  ...
  const inputCls = "w-full px-4 py-3 border border-[#102133]/15 rounded bg-white text-[#102133] placeholder:text-[#102133]/40 focus:outline-none focus:ring-2 focus:ring-[#3B6AB5]/50 focus:border-transparent";
    ...
    <main className="bg-white" data-testid="safety-check-page">
      ...
      {phase === 'questions' && (
        <section className="py-12 md:py-16">
          <div className="container max-w-3xl">
            <p className="text-lg text-[#102133]/70 mb-10 leading-relaxed italic border-l-2 border-[#3B6AB5] pl-6" data-testid="safety-check-frame-text">
            ...
            <div className="space-y-10">
              {QUESTIONS.map((q) => (
                <div key={q.id} className="border-l-2 border-[#3B6AB5]/30 pl-6 py-1" data-testid={`question-${q.id}`}>
          ...
          <div className="container max-w-lg">
            ...
            <form onSubmit={handleGateSubmit} className="space-y-4" data-testid="gate-form">
              ...
              <button
                ...
                className="w-full bg-[#4A7CC9] hover:bg-[#3B6AB5] text-white font-bold py-4 rounded transition-colors disabled:opacity-50 text-base"
        ...
        <section className="py-12 md:py-16" data-testid="results-section">
          <div className="container max-w-3xl">
            ...
            <div className={`inline-block px-4 py-2 rounded text-sm font-semibold mb-8 ${
              ...
              scoreLevel === 'medium' ? 'bg-[#3B6AB5]/15 text-[#8B7222]' :
            ...
            {flaggedTopics.length > 0 && (
              <div className="mb-12 space-y-4" data-testid="results-explanations">
                {flaggedTopics.map((topic) => (
                  <div key={topic} className="border-l-2 border-[#3B6AB5]/30 pl-5 py-2" data-testid={`explanation-${topic.replace(/\s+/g, '-').toLowerCase()}`}>
            ...
            <div className="bg-[#102133] rounded p-8 md:p-10 mb-10" data-testid="results-cta-block">
              ...
              <Link
                ...
                className="bg-[#4A7CC9] hover:bg-[#3B6AB5] text-white font-bold px-8 py-4 rounded transition-colors inline-flex items-center gap-2 text-base mb-4"
            ...
            <div className="mb-10" data-testid="results-reinforcement">
              <div className="w-16 h-px bg-[#3B6AB5]/30 mb-6" />
