...
const SafetyWalkthroughPage = () => (
  <ServiceLandingTemplate
    ...
    seoDescription="On-site safety walkthrough for manufacturers, warehouses, contractors, and fleet operations across North Carolina. Photo-documented findings, OSHA references, and a written report in 48 hours. Starting at $650."
    ...
    priceLine="Starting at $650 · Fixed quote before scheduling · No retainer."
    whoItsFor={{
