...
const SERVICES = {
  ...
  'compliance-readiness-visit': {
    ...
    whatsIncluded: [
      'Physical hazard walkthrough (typically 1\u20133 hours)',
      'Photo-documented findings with CFR references',
      'Structured documentation review (baseline: one facility, up to five categories, up to 25 files)',
      'Representative training and evidence records reviewed',
      'Prioritized findings covering both floor and documentation',
      'Written findings report within 48 hours',
      '30-day corrective-action roadmap',
      'One findings-review call included',
