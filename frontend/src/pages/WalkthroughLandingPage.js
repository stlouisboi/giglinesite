...
const WalkthroughLandingPage = () => {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      setSuccess(true);
      // Scroll to success message in case user is mid-form
      setTimeout(() => {
  ...
  return (
    ...
    >
      ...
      ───────────────────────────────────────────── */}
      <header
        className="px-5 md:px-8 py-4 flex items-center justify-between border-b"
      ...
      {/* ─────────────────────────────────────────────
          SECTION 2 — HERO  (no image, no video, pure type)
      ───────────────────────────────────────────── */}
      <section className="px-5 md:px-8 pt-12 pb-10 md:pt-20 md:pb-14" data-testid="wt-hero">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl leading-relaxed text-white/80 mb-5 max-w-2xl mx-auto">
          ...
          <p className="text-base md:text-lg leading-relaxed text-white/65 max-w-2xl mx-auto">
            ...
            <span style={{ color: GOLD, fontWeight: 600 }}>find them before OSHA does.</span>
          </p>
        </div>
      </section>
      ...
      ───────────────────────────────────────────── */}
      <section className="px-5 md:px-8 py-10 md:py-14" data-testid="wt-next-steps">
        <div className="max-w-4xl mx-auto">
          <p
            className="uppercase font-bold tracking-[0.28em] text-center mb-8"
            style={{ color: GOLD, fontSize: '11px' }}
          >
          ...
          <ol className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            {[
              ...
              >
                ...
                <p className="text-base md:text-[15px] text-white/85 leading-[1.55]">{text}</p>
              </li>
            ))}
          </ol>
        </div>
      ...
      ───────────────────────────────────────────── */}
      <section
        className="px-5 md:px-8 py-12 md:py-16 relative"
        style={{ backgroundColor: SOFT_NAVY }}
        ...
        <div className="max-w-2xl mx-auto">
          {success ? (
            ...
            >
              ...
              <h2 className="text-2xl md:text-3xl font-bold mb-3" style={{ fontFamily: "'Manrope', sans-serif" }}>
                Request received.
              </h2>
              ...
              <p className="mt-6 text-sm text-white/55">
                ...
                <a href="tel:3363298899" style={{ color: GOLD }} className="font-semibold">
                  (336) 329-8899
                </a>
              </p>
            </div>
            ...
            <>
              ...
              <p className="text-center text-white/55 mb-8 text-sm md:text-base">
              ...
              <form onSubmit={submit} className="space-y-4" noValidate data-testid="wt-form">
                ...
                <Field label="Anything specific you want looked at?">
                  ...
                  />
                  <p className="mt-1 text-[11px] text-white/35 text-right" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
                    {form.specifics.length} / 300
                  </p>
                </Field>

                {errorMsg && (
                  <p className="text-sm text-rose-400 text-center" data-testid="wt-form-error">{errorMsg}</p>
                )}
                ...
                <p className="text-center text-sm text-white/55 mt-3 italic">
      ...
      {/* ─────────────────────────────────────────────
          SECTION 5 — TESTIMONIAL + GOOGLE BADGE
      ───────────────────────────────────────────── */}
      <section className="px-5 md:px-8 py-12 md:py-16" data-testid="wt-testimonial-section">
        <div className="max-w-3xl mx-auto">
          ...
          >
            <span
              ...
              style={{ color: GOLD, opacity: 0.18, fontFamily: 'Georgia, serif', fontSize: '110px' }}
            >
              &ldquo;
            </span>
            <p
              className="relative text-xl md:text-2xl leading-[1.45] font-medium mb-6"
          ...
          <a
            ...
            className="mt-6 inline-flex items-center gap-3 px-5 py-3 transition-colors hover:bg-white/5"
            style={{
          ...
          >
            <span className="font-bold text-lg" style={{ color: GOLD }}>5.0</span>
            <span className="flex items-center gap-0.5">
              {[0, 1, 2, 3, 4].map((i) => (
                <Star key={i} size={14} fill={GOLD} color={GOLD} />
              ))}
            </span>
            <span className="text-white/55 text-sm">&middot; Google Review</span>
            <span className="text-white/75 text-sm font-semibold ml-1">Read on Google &rarr;</span>
          </a>
        </div>
      </section>
      ...
      >
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          ...
          <div className="text-sm md:text-[15px] text-white/65 flex flex-col md:items-end gap-2">
            <p className="flex flex-wrap items-center gap-x-3 gap-y-1">
              <a href="mailto:vince@giglinecompliance.com" className="inline-flex items-center gap-1.5 hover:text-white">
                <Mail size={13} />
                vince@giglinecompliance.com
              </a>
              <span className="text-white/30">&middot;</span>
              <a href="tel:3363298899" className="inline-flex items-center gap-1.5 hover:text-white">
                <Phone size={13} />
                (336) 329-8899
              </a>
              <span className="text-white/30">&middot;</span>
              <a href="https://www.giglinecompliance.com" className="hover:text-white">
        ...
        {/* Cross-sell line */}
        <div className="max-w-5xl mx-auto mt-8 pt-6 border-t" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
          <p className="text-xs md:text-sm text-white/55 leading-relaxed">
            For trucking fleets:{' '}
            <span className="text-white/80 font-semibold">GigLine finds the gap. LaunchPath installs the system.</span>{' '}
            <a
...
// ── helpers ────────────────────────────────────
const inputCls =
  'w-full px-4 py-3.5 md:py-4 bg-white/[0.04] border border-white/15 rounded-none focus:outline-none focus:border-[#C5A059] focus:bg-white/[0.06] text-white placeholder-white/30 text-[15px] md:text-base transition-colors';
const selectCls = `${inputCls} appearance-none pr-10 cursor-pointer`;

const Field = ({ label, required, children }) => (
  <label className="block">
    <span className="block text-[11px] md:text-xs uppercase tracking-[0.18em] font-bold text-white/55 mb-2">
      {label}
...
const SelectWithArrow = ({ children }) => (
  <div className="relative">
    ...
    <ChevronDown
      size={16}
      className="absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none text-white/45"
    />
  </div>
);
