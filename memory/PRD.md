...
- **2026-02 Triad SEO Deep Refresh (5 priority cities)**: Added industry-specific 200–280 word lead paragraphs to the 5 priority Triad city pages — Greensboro (manufacturing/aviation/F&B + logistics secondary, 234 words), Winston-Salem (biotech/pharma/medical device, 235 words), High Point (furniture/woodworking/upholstery, 248 words), Kernersville (light manufacturing/plastics/packaging/distribution, 247 words), Lexington (food processing/meat packing, 257 words). Each opens with a geographic/industry anchor before introducing GigLine (e.g., "Greensboro's manufacturing corridor along I-40 and Battleground Avenue includes operations in aviation components, food and beverage production..."). Named anchor employers (Honda Aircraft, Volvo Trucks, RJ Reynolds, Hanesbrands, Tyson Foods, Childress Vineyards, FedEx Ground, UPS), specific OSHA exposures by industry (ammonia refrigeration/PSM for food processing, wood dust/finishing solvents for furniture, cleanroom respiratory for biotech). Also tightened each city's `industries` field + `seoDesc` so hero copy, FAQ answers, and meta descriptions carry the better industry vocabulary. Rendered in new "City Industrial Profile" section between hero and "What You Get". `data-testid="city-lead-{slug}"`.
