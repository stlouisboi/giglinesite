...
- **2026-02 Floor Findings Photos**: Added real industrial photos to homepage "What We Find on the Floor" cards 01 (LOTO tag), 02 (Forklift + PIT), 03 (HazCom workstation), 04 (Electrical junction box). All images optimized to ≤180KB JPEG @ 1200px max, lazy-loaded, with descriptive alt text for SEO + accessibility. Stored in `/app/frontend/public/floor-findings/`. Cards 05 (Egress) and 06 (Recordkeeping) still pending photos. `data-testid="floor-finding-image-{num}"`.
