...
Style:
    ...
    * Auto page numbers footer
    * H2/H3 auto TOC on documents longer than 4 pages
"""
...
@page {{
    ...
    @top-left {{
        content: "GigLine Safety & Compliance";
...
/* Content pages */
.content {{ page: content; string-set: doc-title attr(data-title); }}
h1 {{
    font-family: Georgia, serif;
    color: {NAVY};
    font-size: 22pt;
...
<body>
{cover_html}
<main class="content" data-title="{meta['title']}">
{body_html}
</main>
</body>
</html>"""
